  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <div className="flex items-center gap-2">
        <Link title={"Share article to Twitter - outro"} href={`https://twitter.com/share?url=${siteMetadata.siteUrl}/blog/${slug}&text=${"Read " + title}&via=ricobuilds`}>Twitter</Link>
        <Link title={"Share article to LinkedIn - outro"} href={`https://www.linkedin.com/shareArticle/?url=${siteMetadata.siteUrl}/blog/${slug}&mini=true&title=${"Read " + title}`}>Linkedin</Link>
