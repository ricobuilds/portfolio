export const Newsletter = () => {
  return (
    <section id="journal" className="flex flex-col gap-2">
      ...
      <div className="">
        <p className="mb-8">Get notified when I write something new about AI, gaming and the Metaverse, or launch a new project right in your inbox.</p>
        ...
        <div className="w-full">
          <div className="pt-4">
            <span id="lipline" className="flex text-slate-400">Plus, I send emails every week, never spam or sell your data.</span>
          </div>
        </div>
      </div>
    </section>
