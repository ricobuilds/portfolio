    ...
    <section id="hero">
      <div className="w-full mx-auto space-y-8">
        ...
        <div className="space-y-6 ">
          <p>Hey👋 I&apos;m a fullstack developer with 7 years experience developing frontend interfaces, <br />
            on a mission to build the future of gaming with AI & emerging technologies @ <b>Metasyde</b>.
          </p>
        </div>
      </div>
    </section>
