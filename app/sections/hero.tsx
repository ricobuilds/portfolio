  ...
  return (
    ...
    <div className="mx-auto w-full space-y-8">
      ...
      <div className="space-y-6 max-w-[550px]">
        <p>Hey👋 I&apos;m Enric Trillo, known online as <b>Rico Builds</b> － a fullstack web developer with 7 years experience developing frontend interfaces.</p>
        <p>I&apos;m obsessed about building immersive games in the dawn of the AI era.</p>
        <p className="">Currently learning new disciplines like game development and expanding my skillset, and now leading AI gaming efforts @ <b>Astronomik Labs</b>.</p>
      </div>
