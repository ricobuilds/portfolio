        ...
        <div className={cn("mt-20", "mx-auto")}>
          <div className="flex flex-col gap-16">
            ...
            <section id="cta" className="px-6 bg-jade-500 selection:bg-tingual-300">
              <div className="flex flex-col md:flex-row items-center justify-between self-stretch gap-4 lg:gap-12 mx-auto py-9 max-w-[1360px] w-full">
                <div className="flex max-w-[640px] gap-8">
                  ...
                  <h2 className={cn(clash.className, "font-bold text-2xl lg:text-6xl")}>
