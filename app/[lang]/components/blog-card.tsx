...
export const BlogCard = ({ post, lang }: { post: MDXArticle, lang: Locale }) => {
  return (
    <article className="flex flex-col w-full gap-3 overflow-hidden border-2 border-black outline-none rounded-2xl group hover:shadow-[8px_8px_0px_rgba(0,0,0,1)] transition">
